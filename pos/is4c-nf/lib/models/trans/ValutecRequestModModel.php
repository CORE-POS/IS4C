...
/**
  @class ValutecRequestModModel
*/
class ValutecRequestModModel extends BasicModel
{

    protected $name = "valutecRequestMod";
    ...
    'origAuthCode' => array('type'=>'VARCHAR(9)'),
    ...
    public function origAuthCode()
    {
        if(func_num_args() == 0) {
            if(isset($this->instance["origAuthCode"])) {
                return $this->instance["origAuthCode"];
            } elseif(isset($this->columns["origAuthCode"]["default"])) {
                return $this->columns["origAuthCode"]["default"];
            } else {
                return null;
            }
        } else {
            $this->instance["origAuthCode"] = func_get_arg(0);
        }
    }
