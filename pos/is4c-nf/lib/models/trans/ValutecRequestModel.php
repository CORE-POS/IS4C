...
/**
  @class ValutecRequestModel
*/
class ValutecRequestModel extends BasicModel
{

    protected $name = "valutecRequest";
    ...
    'terminalID' => array('type'=>'VARCHAR(20)'),
    ...
    {
        if(func_num_args() == 0) {
            if(isset($this->instance["terminalID"])) {
                return $this->instance["terminalID"];
            } elseif(isset($this->columns["terminalID"]["default"])) {
                return $this->columns["terminalID"]["default"];
            } else {
                return null;
            }
        } else {
            $this->instance["terminalID"] = func_get_arg(0);
        }
    }
