...
csc /target:library /r:DelegateForm.dll /r:Bitmap.dll /r:USBLayer.dll /out:SPH.dll SerialPortHandler.cs SPH_Magellan_Scale.cs SPH_Ingenico_i6550.cs SPH_SignAndPay_USB.cs
