...
$patQ = "SELECT FY,Purchase AS Purchases,discounts as Discounts,rewards as Rewards,net_purch as 'Net Purchases',tot_pat as 'Total Patronage',cash_pat as 'Cash Portion',equit_pat as 'Equity Portion' FROM patronage where cardno = $memID";
