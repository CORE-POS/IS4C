...
if (count($filestoprocess) == 0){
	...
	$page_title = "Fannie : Loaded Herb Pharm Prices";
	$header = "Loaded Herb Pharm Prices";
	include($FANNIE_ROOT."src/header.html");

	echo "Finished processing Herb Pharm price file<br />";
	if ($PRICEFILE_USE_SPLITS){
	...
	header("Location: loadHPprices.php?filestoprocess=$sendable_data&processed=$encoded2");
