...
class FrontierUploadPage extends \COREPOS\Fannie\API\FannieUploadPage {

    public $title = "Fannie - Frontier Prices";
    public $header = "Upload Frontier price file";
    public $themed = true;

    public $description = '[Frontier Catalog Import] specialized vendor import tool. Column choices
    default to Frontier price file layout.';
    ...
    protected function getVendorID()
    {
        ...
        $vid = $this->connection->getValue($idP, array('Frontier'));
