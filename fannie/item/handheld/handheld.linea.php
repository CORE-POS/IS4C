...
Device = new ScannerDevice({
    ...
    magneticCardData: function (track1, track2, track3){
        alert('Card Read "'+track1+'", "'+track2+'", "'+track3+'"');
    },
    magneticCardRawData: function (data){
        console.log('Card Read "'+data+'"');
    },
...
if(isset($_REQUEST['upc']) && !empty($_REQUEST['upc'])){
    if (isset($_REQUEST['submitBtn'])){
        ...
        if ($num > 1){
            ...
            while($row=$dbc->fetch_row($result)){
                printf("<a href=\"handheld.linea.php?submit=Submit&upc=%s\">%s</a><br />",
            ...
            echo "<form action=handheld.linea.php method=get>";
            ...
            echo "<tr><td colspan=2><input type=submit value=\"Back\"
                ...
                onclick=\"top.location='handheld.linea.php';return false;\"
                /></td></tr>";
    ...
    elseif(isset($_REQUEST['submit2'])){
        ...
        printf("[ <a href=\"handheld.linea.php?submit=Submit&upc=%s\">View Last Item</a> ]<br />",
            $_REQUEST['upc']);
...
echo "<form action=handheld.linea.php id=\"lookupform\" method=get>";
echo "<table><tr><td>";
...
echo '<a onclick="location.reload(); return false;">Refresh Page</a>';
echo "</body>";
