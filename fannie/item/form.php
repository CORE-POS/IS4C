<?php
	function form($backoffice) {
		global $FANNIE_ROOT,$dbc;
		if (isset($backoffice['product_detail'])) {
			require_once($FANNIE_ROOT."lib/table_departments.php");
				$departments_result=get_departments(&$backoffice);
			require_once($FANNIE_ROOT."lib/table_subdepts.php");
			...
			<form action="./" method="post" name="edit">
				...
				while ($row=$dbc->fetch_array($departments_result)) {
					$html.='
				...
				while ($row=$dbc->fetch_array($subdepartments_result)) {
					$html.='
