...
*/
class WFC_SingleHybrid_PDF extends FpdfWithBarcode
{
    private $tagdate;
...
function WFC_SingleHybrid($data,$offset=0){

//$pdf=new WFC_SingleHybrid_PDF('P','mm','Letter'); //start new instance of PDF
$pdf = new WFC_SingleHybrid_PDF('L', 'mm', array(105, 148));
