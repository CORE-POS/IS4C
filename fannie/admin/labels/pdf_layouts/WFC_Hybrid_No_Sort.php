...
*/
class WFC_Hybrid_No_Sort_PDF extends FpdfWithBarcode
{
    private $tagdate;
...
function WFC_Hybrid_No_Sort($data,$offset=0){

$pdf=new WFC_Hybrid_No_Sort_PDF('P','mm','Letter'); //start new instance of PDF
