...
(function(a){a.appendStylesheet=a.appendStylesheet||function(b,e){if(!(document.body||0)){setTimeout(function(){a.appendStylesheet.apply(a,[b,e])},500);return a}var c="stylesheet-"+b.replace(/[^a-zA-Z0-9]/g,""),d=a("#"+c);if(typeof e==="undefined")e=false;if(d.length===1)if(e)d.remove();else return a;d=document.getElementsByTagName("body")[0];var f=document.createElement("link");f.type="text/css";f.rel="stylesheet";f.media="screen";f.href=b;f.id=c;d.appendChild(f);return a};
a.appendScript=a.appendScript||function(b,e){if(!(document.body||0)){setTimeout(function(){a.appendScript.apply(a,[b,e])},500);return a}var c="script-"+b.replace(/[^a-zA-Z0-9]/g,""),d=a("#"+c);if(typeof e==="undefined")e=false;if(d.length===1)if(e)d.remove();else return a;d=document.getElementsByTagName("body")[0];var f=document.createElement("script");f.type="text/javascript";f.src=b;f.id=c;d.appendChild(f);return a}})(jQuery);
...
this.fn;e.load&&this.load();e.highlight&&this.highlight();return this},load:function(){var b=this.config,e=b.prettifyBaseUrl,c=b.baseUrl;b=b.themes;if(!this.loaded()){a.appendScript(e+"/prettify.min.js");a.appendStylesheet(e+"/prettify.min.css");a.appendStylesheet(c+"/styles/style.min.css");a.each(b,function(d,f){a.appendStylesheet(c+"/styles/theme-"+f+".min.css")});this.loadedExtras=true}return this},loadedExtras:false,loaded:function(){return typeof prettyPrint!==
