...
*/
class LabelPDF extends FannieModule {

	public $required = True;
	public $description = "Module for generating label PDFs";
	...
	*/
	...
	/**
	  ...
	  The easiest way is using BarcodePDF's Output() method.
	*/
	function output_pdf(){
		$hspace = 0.79375;
		$h = 29.36875;
		...
		$pdf=new BarcodePDF('P', 'mm', 'Letter');
