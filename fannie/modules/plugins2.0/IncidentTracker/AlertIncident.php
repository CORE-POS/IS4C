...
class AlertIncident extends FannieRESTfulPage
{
    ...
    protected function post_escalate_handler()
    {
        ...
        $to = 'andy@wholefoods.coop,jkrussow@wholefoods.coop,eosterman@wholefoods.coop,tbeaudreau@wholefoods.coop,skvale@wholefoods.coop,shannigan@wholefoods.coop';
