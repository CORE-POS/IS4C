...
class EOMDiscountLayer extends FannieReportPage
{
    ...
    public function fetch_report_data()
    {
        ...
        $query1="SELECT t.date_id,
            ...
            t.memType,
            SUM(t.total) AS ttl
        FROM {$warehouse}sumDiscountsByDay AS t
        ...
        while ($row = $this->connection->fetchRow($res)) {
            ...
            $link = sprintf('<a href="EOMDiscountDetail.php?date=%s&store=%d&type=%d">%s</a>',
