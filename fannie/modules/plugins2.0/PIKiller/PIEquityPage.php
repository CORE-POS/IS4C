...
class PIEquityPage extends PIKillerPage {
	...
	protected function get_handler(){
		...
		$this->models['equity'] = $this->get_model(FannieDB::get($FANNIE_TRANS_DB), 'StockpurchasesModel',
						array('card_no'=>$this->id),'tdate');
		$this->models['equity'] = array_reverse($this->models['equity']);
	...
	protected function get_id_view(){
		...
		foreach($this->models['equity'] as $transaction){
