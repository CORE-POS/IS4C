...
/**
  @class ObfLaborModel
*/
class ObfLaborModelV2 extends BasicModel
{
    ...
    public function splhTarget()
    {
        if(func_num_args() == 0) {
            if(isset($this->instance["splhTarget"])) {
                return $this->instance["splhTarget"];
            } else if (isset($this->columns["splhTarget"]["default"])) {
                return $this->columns["splhTarget"]["default"];
            } else {
                return null;
            }
        } else if (func_num_args() > 1) {
            ...
            if (!isset($this->instance["splhTarget"]) || $this->instance["splhTarget"] != func_get_args(0)) {
                if (!isset($this->columns["splhTarget"]["ignore_updates"]) || $this->columns["splhTarget"]["ignore_updates"] == false) {
                    $this->record_changed = true;
                }
            }
            $this->instance["splhTarget"] = func_get_arg(0);
        }
        return $this;
    }
