...
class SingleWfcSmartSigns12UpL extends \COREPOS\Fannie\API\item\signage\SingleCompact12UpL 
{
    ...
    protected $left = 19.0; // moves all text except dates
