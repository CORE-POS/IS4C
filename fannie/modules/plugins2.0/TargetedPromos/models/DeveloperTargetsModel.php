...
/**
  @class DeveloperTargetsModel
*/
class DeveloperTargetsModel extends BasicModel
{

    protected $name = "DeveloperTargets";

    protected $columns = array(
    'developerTargetID' => array('type'=>'INT', 'index'=>true, 'increment'=>true),
    ...
    'lastRedeemDate' => array('type'=>'DATETIME'),
    );
    ...
    public function developerTargetID()
    {
        if(func_num_args() == 0) {
            if(isset($this->instance["developerTargetID"])) {
                return $this->instance["developerTargetID"];
            } else if (isset($this->columns["developerTargetID"]["default"])) {
                return $this->columns["developerTargetID"]["default"];
            } else {
                return null;
            }
            ...
            if (!isset($this->instance["developerTargetID"]) || $this->instance["developerTargetID"] != func_get_args(0)) {
                if (!isset($this->columns["developerTargetID"]["ignore_updates"]) || $this->columns["developerTargetID"]["ignore_updates"] == false) {
                    $this->record_changed = true;
                }
            }
            $this->instance["developerTargetID"] = func_get_arg(0);
        }
        return $this;
    }
    ...
    public function lastRedeemDate()
    {
        if(func_num_args() == 0) {
            if(isset($this->instance["lastRedeemDate"])) {
                return $this->instance["lastRedeemDate"];
            } else if (isset($this->columns["lastRedeemDate"]["default"])) {
                return $this->columns["lastRedeemDate"]["default"];
            } else {
                return null;
            }
        } else if (func_num_args() > 1) {
            ...
            if (!isset($this->instance["lastRedeemDate"]) || $this->instance["lastRedeemDate"] != func_get_args(0)) {
                if (!isset($this->columns["lastRedeemDate"]["ignore_updates"]) || $this->columns["lastRedeemDate"]["ignore_updates"] == false) {
                    $this->record_changed = true;
                }
            }
            $this->instance["lastRedeemDate"] = func_get_arg(0);
        }
        return $this;
    }
