...
*/
class PickupOrdersHistoryModel extends BasicModel
{
    protected $name = "PickupHistoryOrders";

    protected $columns = array(
    'pickupOrderHistoryID' => array('type'=>'INT', 'primary_key'=>true, 'increment'=>true),
