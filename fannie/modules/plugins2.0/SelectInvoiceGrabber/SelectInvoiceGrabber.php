...
/**
*/
class SelectInvoiceGrabber extends \COREPOS\Fannie\API\FanniePlugin 
{
    ...
    public $plugin_description = 'Plugin for downloading Select Nutrition invoices (via UNFI) and importing them as purchase orders';
}
