...
class CCredHistorySumModel extends BasicModel
{
    ...
    public function ccHistorySumID()
    {
        if(func_num_args() == 0) {
            if(isset($this->instance["ccHistorySumID"])) {
                return $this->instance["ccHistorySumID"];
            } else if (isset($this->columns["ccHistorySumID"]["default"])) {
                return $this->columns["ccHistorySumID"]["default"];
            } else {
                return null;
            }
        } else if (func_num_args() > 1) {
            ...
            if (!isset($this->instance["ccHistorySumID"]) || $this->instance["ccHistorySumID"] != func_get_args(0)) {
                if (!isset($this->columns["ccHistorySumID"]["ignore_updates"]) || $this->columns["ccHistorySumID"]["ignore_updates"] == false) {
                    $this->record_changed = true;
                }
            }
            $this->instance["ccHistorySumID"] = func_get_arg(0);
        }
        return $this;
    }
