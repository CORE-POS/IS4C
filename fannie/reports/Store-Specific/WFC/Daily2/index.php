...
$tenderQ = "SELECT t.TenderName,-sum(d.total) as total, d.quantity
...
$equityQ = "SELECT d.card_no,t.dept_name, -1*sum(stockPurchase) as total 
...
$arQ = "SELECT d.card_no,'STORE CHARGE' as description,
SUM(d.Charges),
...
$discQ = "SELECT m.memDesc, -1*SUM(d.total) AS Discount,SUM(transCount)
...
$transQ = "SELECT d.total,d.quantity,d.transCount,m.memdesc
