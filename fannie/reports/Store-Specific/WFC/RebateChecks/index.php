...
$q = "select year(tdate),month(tdate),day(tdate),count(*) From is4c_trans.dlog_90_view as d 
...
$q = "select year(tdate),month(tdate),day(tdate),sum(quantity) From is4c_trans.dlog_90_view as d 
