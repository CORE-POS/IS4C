...
class GeneralDayNoChartsReport extends FannieReportPage 
{
    public $description = '[General Day Report without Charts] lists tenders, sales, discounts, and taxes for a given day
        (should net to zero). Also listed are transaction count &amp; size information by member type and
        equity sales for the day. Charts are suppressed.'; 
...
HTML;
    ...
    public function helpContent()
    {
        return '<p>
            ...
            <p>
            This report is the same as the General Day Report but
            without the charts/graphs.
            </p>
';
    }
}
