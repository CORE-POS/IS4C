...
$r = $dbc->query($q);
if ($dbc->num_rows($r) == 0){
	echo "<em>Error: equity department(s) don't exist</em>";
	echo "<br /><br />";
	echo "<a href=\"corrections.php\">Back</a>";
	return;
}
...
if (isset($_REQUEST['submit1']) || isset($_REQUEST['submit2'])){
	...
	if (!isset($depts[$dept])){
		echo "<em>Error: equity department doesn't exist</em>";
		echo "<br /><br />";
	...
	if (isset($_REQUEST['submit1'])){
		...
		echo "</p><p>";
		echo "<input type=\"hidden\" name=\"type\" value=\"equity_transfer\" />";
...
echo "From member #<input type=\"text\" name=\"memFrom\" size=\"5\" value=\"$memNum\" /> ";
