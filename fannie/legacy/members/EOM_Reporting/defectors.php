...
if (isset($_GET['excel'])){
    ...
    header('Content-Disposition: attachment; filename="defectors.xls"');
}
...
array_push($headers,date("M y",mktime(0,0,0,date("n")-5,1,date("Y"))));
array_push($headers,date("M y",mktime(0,0,0,date("n")-4,1,date("Y"))));
