...
function saveitem(id){
	...
	phpSend('saveitem&id='+id+'&item='+item+'&orderno='+orderno+'&units='+units+'&cases='+cases+'&fraction='+fraction+'&price='+price+'&size='+size);
}

function deleteitem(id){
	if (confirm("Delete this item?")){
		saveAll();
		phpSend("deleteitem&id="+id);
	}
}

function moveUp(id,category){
	phpSend("moveUp&id="+id+"&category="+category);
}

function moveDown(id,category){
	phpSend("moveDown&id="+id+"&category="+category);
}
...
function saveCat(id){
	...
	phpSend('changeCat&id='+id+'&newcat='+newcat);
}
