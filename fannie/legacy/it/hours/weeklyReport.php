...
if (!validateUserQuiet('view_all_hours')){
	header("Location: {$FANNIE_URL}auth/ui/loginform.php?redirect={$FANNIE_URL}legacy/it/hours/weeklyReport.php");
	return;
}
...
$query = "SELECT e.empID,e.name,e.adpID,f.status,w.hours
