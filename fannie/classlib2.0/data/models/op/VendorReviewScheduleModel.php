...
/**
  @class VendorReviewScheduleModel
*/
class VendorReviewScheduleModel extends BasicModel
{
    protected $name = "vendorReviewSchedule";
    protected $preferred_db = 'op';

    protected $columns = array(
    'vid' => array('type'=>'INT', 'primary_key'=>true),
    'rate' => array('type'=>'INT'),
