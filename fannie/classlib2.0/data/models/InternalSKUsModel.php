...
class InternalSKUsModel extends BasicModel 
{
    ...
    public function our_sku()
    {
        if(func_num_args() == 0) {
            ...
            } else if (isset($this->columns["our_sku"]["default"])) {
            ...
            if (!isset($this->instance["our_sku"]) || $this->instance["our_sku"] != func_get_args(0)) {
                if (!isset($this->columns["our_sku"]["ignore_updates"]) || $this->columns["our_sku"]["ignore_updates"] == false) {
    ...
    public function vendor_sku()
    {
        if(func_num_args() == 0) {
            ...
            } else if (isset($this->columns["vendor_sku"]["default"])) {
            ...
            if (!isset($this->instance["vendor_sku"]) || $this->instance["vendor_sku"] != func_get_args(0)) {
                if (!isset($this->columns["vendor_sku"]["ignore_updates"]) || $this->columns["vendor_sku"]["ignore_updates"] == false) {
                    $this->record_changed = true;
                }
            }
